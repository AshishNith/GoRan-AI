...
const socialLinks = [
  { label: 'WhatsApp', href: 'https://wa.me/919934225353?text=Hi%20GoRan%20AI,%20I\'d%20like%20to%20discuss%2520an%2520AI%2520automation%2520project%2520for%2520my%2520business.' },
          ...
          <div className="grid grid-cols-2 lg:grid-cols-[1.4fr_0.8fr_0.8fr_0.8fr_1.2fr] gap-10 lg:gap-8">
            ...
            <div className="flex flex-col gap-5 items-start col-span-2 lg:col-span-1 mt-6 lg:mt-0 pt-8 lg:pt-0 border-t lg:border-none border-white/[0.06]">
              ...
              <a
                ...
                className="text-white/40 hover:text-white transition-colors duration-200 text-xs no-underline mt-1 block"
              >
                goran.dotin@gmail.com
              </a>
              <a
                href="https://wa.me/919934225353?text=Hi%20GoRan%20AI,%20I'd%20like%20to%20discuss%2520an%2520AI%2520automation%2520project%2520for%2520my%2520business."
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-400 hover:text-emerald-300 transition-colors duration-200 text-xs no-underline mt-2 flex items-center gap-1.5 font-mono"
              >
