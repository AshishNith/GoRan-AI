...
const socialLinks = [
  { label: 'WhatsApp', href: 'https://wa.me/919934225353?text=Hi%20GoRan%20AI,%20I\'d%20like%20to%20discuss%20an%20AI%20automation%20project%20for%20my%20business.' },
        ...
        <div className="pt-20 pb-16 border-b border-white/[0.06]">
          <div className="grid grid-cols-2 lg:grid-cols-[1.4fr_0.8fr_0.8fr_0.8fr_1.2fr] gap-10 lg:gap-8">
            ...
            <div className="flex flex-col gap-5 items-start col-span-2 lg:col-span-1 mt-6 lg:mt-0 pt-8 lg:pt-0 border-t lg:border-none border-white/[0.06]">
              ...
              <a
                href="https://wa.me/919934225353?text=Hi%20GoRan%20AI,%20I'd%20like%20to%20discuss%20an%20AI%20automation%20project%20for%20my%20business."
                target="_blank"
                rel="noopener noreferrer"
