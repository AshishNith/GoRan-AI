...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-50 font-body flex items-center gap-3 pointer-events-none">
      ...
      <div
        className={`pointer-events-auto bg-brand-dark text-white text-[11px] font-medium py-2 px-3.5 rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.15)] border border-white/[0.08] transition-all duration-500 ease-out flex items-center gap-2 max-w-[200px] sm:max-w-xs ${
          showTooltip
